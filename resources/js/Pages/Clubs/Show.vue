...
<template>
    <AppLayout>
        <template #header>
            <h1 class="text-center text-2xl font-bold leading-7 text-gray-300 sm:text-3xl sm:truncate py-4 bg-gradient-to-l from-green-500 to-green-800 ">MOSTRAR LOS CLUBES</h1>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <table class="rounded-t-lg mt-5 min-w-full mx-auto bg-gray-800 text-gray-100">
                        ...
                        <tr class="text-left border-b border-gray-300">
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100 uppercase tracking-wider">Nombre de Club</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-100 uppercase tracking-wider">Nombre de Delegado del Club</th>
                        ...
                        <tr v-for="club in clubs" :key="club.id">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="ml-4">
                                <div class="text-sm font-medium">{{ club.clubname }}</div>
                                </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm">{{ club.clubdelegate }}</div>                    
                            </td>
                            <td class="flex m-2">
                            <inertia-link 
